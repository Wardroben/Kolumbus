...
import ru.smalljinn.kolumbus.data.image.IMAGES_PATH_NAME
...
class PhotoFileProviderTest {
    ...
    fun photoFileProvider_gets_uri_for_new_file() {
        ...
        try {
            ...
            val uri: Uri? = ImageFileProvider.getUriForFile(testFile, context)
    ...
    fun photoFileProvider_creates_file_for_photo() {
        val photoFile = ImageFileProvider.createFileForImage(context, "test.image")
        try {
